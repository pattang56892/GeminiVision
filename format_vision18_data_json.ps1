<# 
.SYNOPSIS
  Reads vision18_data.json conversation and writes a more readable .txt output.
...
.EXAMPLE
  .\convert_vision18_data.ps1 -InputPath ".\vision18_data.json" -OutputPath ".\formatted_vision18_data.txt"
#>
