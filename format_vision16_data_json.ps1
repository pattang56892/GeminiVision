<# 
.SYNOPSIS
  Reads vision16_data.json conversation and writes a more readable .txt output.
...
.EXAMPLE
  .\convert_vision16_data.ps1 -InputPath ".\vision16_data.json" -OutputPath ".\formatted_vision16_data.txt"
#>
